...
- iPhone 6.9インチの欄: `docs/store-assets/promo/appstore69-1.png` 〜 `appstore69-4.png`（1320×2868）をこの順で
- 6.5インチの欄: `appstore65-1.png` 〜 `appstore65-4.png`（1284×2778）。6.7インチ（1290×2796）は `appstore-1..4.png`
- iPad は対象外（iPhone のみ）
...
2. 「プレビューとスクリーンショット」: 前の版の画像が入っているので、6.9インチ（または6.5インチ）の欄の4枚を消し、新しい4枚（4 の「スクリーンショット」）を 1 → 4 の順にドラッグ
