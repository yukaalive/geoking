...
const I18N = {
  ja: {
    ...
    create_room: '部屋を作る', code_ph: '友だちの部屋の名前', join: '参加する', room_label: '部屋', enter_room_name: '部屋の名前を入力してください', learn_zukan: '図鑑で学ぶ', public_rooms: '公開中の部屋', refresh: '更新',
    ...
    players: 'プレイヤー', add_bot: 'ボットを追加', lobby_note_pre: '友だちはトップページの「参加する」に部屋の名前 ', lobby_note_post: ' を入れるだけで入れます。招待リンクの共有でもOK。ゲームが始まったあとでも途中参加できます。ゲーム中でもホストは右上の「ロビーへ」で中断して設定を変えられます。',
  ...
  en: {
    ...
    create_room: 'Create room', code_ph: "Friend's room name", join: 'Join', room_label: 'Room', enter_room_name: 'Enter the room name', learn_zukan: 'Study mode', public_rooms: 'Public rooms', refresh: 'Refresh',
    ...
    players: 'Players', add_bot: 'Add bot', lobby_note_pre: 'Friends can join by typing the room name ', lobby_note_post: ' under "Join" on the top page, or by using the invite link. Others can join even after the game starts. The host can pause with "Lobby" at the top right to change settings.',
