...
const I18N = {
  ja: {
    ...
    players: 'プレイヤー', add_bot: 'ボットを追加', lobby_note_pre: '友だちはトップページの「参加する」に部屋の名前 ', lobby_note_post: ' を入れるだけで入れます。',
    room_settings: '部屋の設定', host_only: '（ホストのみ変更できます）', room_name: '部屋の名前', room_title_ph: '例：ゆかの部屋',
    public_room_label: '公開部屋にする',
    start_game: 'ゲーム開始', start_with_bot: 'botとゲーム開始', start_rounds: 'ゲーム開始（{n}ラウンド）', waiting_host_start: 'ホストが開始するのを待っています…',
    ...
    others_live: 'みんなの手札', others_hidden: 'みんなの手札（何を出したかは公開まで分かりません）',
    ...
    rank_n: '{n}位', you_paren: '（あなた）', reading: '読み：', gain: '+{n}点', gain_1: '+{n}点',
    final_label: '最終結果', next_round: '次のラウンド（{n} / {total}）', next_in: '{sec}秒後に{label}へ', won_point: '{names} が1位！', draw_nodata: '全員データなし… 引き分け',
    ...
    playing: '対戦中', join_short: '参加', room_of: '{name}の部屋', players_n: '{n}/8人', rooms_fetch_failed: '一覧を取得できませんでした',
  ...
  en: {
    ...
    players: 'Players', add_bot: 'Add bot', lobby_note_pre: 'Friends can join by typing the room name ', lobby_note_post: ' under "Join" on the top page.',
    ...
    start_game: 'Start game', start_with_bot: 'Start with a bot', start_rounds: 'Start game ({n} rounds)', waiting_host_start: 'Waiting for the host to start…',
    ...
    others_live: "Everyone's cards", others_hidden: "Everyone's cards (plays are hidden until the reveal)",
    ...
    rank_n: '#{n}', you_paren: ' (you)', reading: 'Reading: ', gain: '+{n} pts', gain_1: '+{n} pt',
    final_label: 'final results', next_round: 'round {n} / {total}', next_in: 'Next: {label} in {sec}s', won_point: '{names} took 1st!', draw_nodata: 'No data for anyone… draw',
    ...
    playing: 'Playing', join_short: 'Join', room_of: "{name}'s room", players_n: '{n}/8 players', rooms_fetch_failed: 'Could not load the list',
