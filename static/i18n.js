...
const I18N = {
  ja: {
    ...
    room_settings: '部屋の設定', host_only: '（ホストのみ変更できます）', room_name: '部屋の名前（友だちはこの名前で参加）', room_title_ph: '例：ゆかの部屋',
  ...
  en: {
    ...
    room_settings: 'Room settings', host_only: '(host only)', room_name: 'Room name (friends join with this)', room_title_ph: "e.g. Hanako's room",
