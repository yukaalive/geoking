...
PROMPTS = [
    ...
    P('west', 'basic', '最も西にある国は？', 'lng', 'min', 2, '経度（西経が大きいほど西）で比較'),
    ...
    P('forest_max', 'climate', '森林率が高い国は？', 'forest_pct', 'max', 2),
    P('forest_min', 'climate', '森林率が低い国は？', 'forest_pct', 'min', 3),
    P('equator', 'climate', '赤道に近い国は？', 'abs_lat', 'min', 1),
    P('agri_max', 'climate', '農地の割合が高い国は？', 'agri_pct', 'max', 3),
    P('co2_max', 'climate', '一人当たりCO2排出量が多い国は？', 'co2_pc', 'max', 3),
    # --- 宗教
    ...
    P('folk_max', 'religion', '民間信仰の割合が高い国は？', 'rel_folk', 'max', 3),
    P('chr_min', 'religion', 'キリスト教徒の割合が低い国は？', 'rel_chr', 'min', 2),
    P('div_max', 'religion', '宗教が多様な国は？', 'rel_div', 'max', 3, '最大宗派の割合が低いほど多様'),
    # --- 社会・暮らし
    ...
    P('net_max', 'society', 'インターネット利用率が高い国は？', 'internet_pct', 'max', 2),
    P('tour_max', 'society', '外国人観光客が多い国は？', 'tourists', 'max', 2),
    P('phys_max', 'society', '人口あたり医師数が多い国は？', 'physicians', 'max', 3),
    P('elec_min', 'society', '電力アクセス率が低い国は？', 'elec_pct', 'min', 3),
]
