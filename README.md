...
3. ホストがカテゴリ（基本／気候・自然／宗教／社会）、ラウンド数、手札枚数、制限時間、難易度、国名表示を設定
4. 各ラウンド全員が同時に1枚選ぶ → 全員出そろったら一斉に公開 → 最もお題に合った人に1点（同値は全員1点）
...
| | 国旗王（原作） | GeoKing |
|---|---|---|
| お題 | 面積・人口・GDP・正式名称・南北・軍事費など | 原作系＋気候・宗教・社会の4カテゴリ42種 |
